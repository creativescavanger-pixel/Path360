...
const founderRoute = useDiagnosticStore(
  ...
  async function handleOnboardingContinue(event) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form
          onSubmit={handleOnboardingContinue}
          style={{
            display: 'grid',
            gap: 16,
            marginTop: 28,
        ...
        >
          ...
          {isExplorer ? (
            <ProfileField
              ...
              helpText="Optional — a few words are enough"
              textarea
              rows={4}
            />
          ) : (
            <>
              ...
              <ProfileField
                ...
                helpText="Optional — a simple sentence is enough"
                textarea
                rows={4}
              />
            </>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Change this when your work has moved forward—for example, when an
          opportunity you were exploring has become a venture you are ready to
          build. Your earlier PATH360 work remains available.
        </p>

        <button
          type="button"
          onClick={() => navigate('/app/journey-start?change=1')}
          style={{
            minHeight: 40,
            padding: '0 15px',
